...
var cnHeader = "3612262624047ee87660be1a707519a443b1c1ce3d248cbfc6c15870f6c5daa23612262624047ee87660be1a707519a443b1c1ce3d248cbfc6c15870f6c5daa276381b4d76381b4d76381b4d76";
var cnheaderbuf = Buffer.from(cnHeader, 'hex');
...
describe('BlockHeader', function() {
  ...
  describe('#fromObject', function() {
    ...
    it('should set all the variables', function() {
      var bh = BlockHeader.fromObject({
        ...
        bits: bits,
        nonce: nonce,
        cnHeader: cnheaderbuf.toString('hex')
      });
      should.exist(bh.version);
      should.exist(bh.prevHash);
      should.exist(bh.merkleRoot);
  ...
  describe('#fromRawBlock', function() {
    ...
    it('should instantiate from a raw block binary', function() {
      ...
      new BN(x.bits).toString('hex').should.equal('1d10def3');
    });
  ...
  describe('#getDifficulty', function() {
    it('should get the correct difficulty for block 86756', function() {
      var x = BlockHeader.fromRawBlock(dataRawBlockBuffer);
      x.bits.should.equal(0x1D10DEF3);
      x.getDifficulty().should.equal(592727.7);
    });
