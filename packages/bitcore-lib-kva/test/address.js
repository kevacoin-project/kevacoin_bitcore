...
describe('Address', function() {
  ...
  var str = 'KChi6BMPf4hfmAvBMAG5mVvdgXiwcgQnLk';
  ...
  /*
  // KVA does not use legacy address.
  ...
  */
  ...
  // livenet p2sh
  var P2SHLivenet = [
    'VWpBcJGbYeqpu2kETkBxGfwa9Fo3qVGfdH',
    'VDSmmQfQrRgiFMt4hAAdrr94s7G9tKDuC2',
    'VC7t8LQvMFzFj9o2b7JQjS6bCLdpDv6kts',
    'VR4uAUcPNhMcsu6HG2ap1zWxmkYjkNmaVs',
    '\t \nVR4uAUcPNhMcsu6HG2ap1zWxmkYjkNmaVs \r'
  ];
  ...
  describe('validation', function() {
    ...
    it('isValid returns true on a valid address', function() {
      var valid = Address.isValid('VW8rmeLM3yWnisU18M3kZhRK1tKHF6KgRm', 'livenet');
    ...
    it('addresses with whitespace are validated correctly', function() {
      var ws = '  \r \t    \n VW8rmeLM3yWnisU18M3kZhRK1tKHF6KgRm \t \n            \r';
      var error = Address.getValidationError(ws);
      should.not.exist(error);
      Address.fromString(ws).toString().should.equal('VW8rmeLM3yWnisU18M3kZhRK1tKHF6KgRm');
    });
  ...
  /*
  // KVA does not support legacy address.
  ...
  describe('encodings', function() {
    ...
    */
    ...
    it('should make this address from a compressed pubkey', function() {
      ...
      address.toString().should.equal('KFtRPo7oVD4kfQ2NByPDP2ixxh44z1cu6M');
    });
    ...
    it('should make this address from an uncompressed pubkey', function() {
      ...
      a.toString().should.equal('KCWg6bNhFbZPUVDy4yGQgtsNBPUaoRi7JH');
      var b = new Address(pubkey, 'livenet', 'pubkeyhash');
      b.toString().should.equal('KCWg6bNhFbZPUVDy4yGQgtsNBPUaoRi7JH');
    });
    ...
    describe('from a script', function() {
      ...
      it('should make this address from a p2pkh output script', function() {
        ...
        a.toString().should.equal('KRXJ7sUZCPz2pPNEsbg37E3qYyYVNeVLjY');
        var b = new Address(s, 'livenet');
        b.toString().should.equal('KRXJ7sUZCPz2pPNEsbg37E3qYyYVNeVLjY');
      });
      ...
      it('should make this address from a p2sh input script', function() {
        ...
        var a = Address.fromScript(s, 'livenet');
        a.toString().should.equal('VRsrMqUb4EccZdRh7apykjtjB8gjdKP2m3');
        var b = new Address(s, 'livenet');
        b.toString().should.equal('VRsrMqUb4EccZdRh7apykjtjB8gjdKP2m3');
      });

      it('returns the same address if the script is a pay to public key hash out', function() {
        var address = 'KQwSSQkibJVDpCLvawxKxd22TNBFjgB5Vd';
      ...
      it('returns the same address if the script is a pay to script hash out', function() {
        var address = 'VW8rmeLM3yWnisU18M3kZhRK1tKHF6KgRm';
  ...
  */
  ...
  describe('#inspect', function() {
    it('should output formatted output correctly', function() {
      var address = new Address(str);
      var output = '<Address: KChi6BMPf4hfmAvBMAG5mVvdgXiwcgQnLk, type: pubkeyhash, network: livenet>';
  ...
  describe('creating a P2SH address from public keys', function() {
    ...
    it('can create an address from a set of public keys', function() {
      ...
      address.toString().should.equal('VQs3PV6ar83opHq84iQhD8FDPhYUm4Lqoa');
    ...
    it('can create an address from a set of public keys with a nested witness program', function() {
      ...
      address.toString().should.equal('VYnX1eZZdVWGCaA2yi82dL6aTnxfmJWGUr');
    });
