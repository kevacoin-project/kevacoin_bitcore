...
describe('PrivateKey', function() {
  ...
  var wifLivenet = 'MeehDpiDDnSXn6kfz7QLykvWMF43W4UN18qSMRNk9QufAE7WQRXt';
  ...
  it('should create a private key from WIF string', function() {
    var a = new PrivateKey('MbProG36JqHhCberkBtXC3CvXpfbi37tGSU5HpdnvJwL4zjgnDUW');
    should.exist(a);
    should.exist(a.bn);
  });

  it('should create a private key from WIF buffer', function() {
    var a = new PrivateKey(Base58Check.decode('MbProG36JqHhCberkBtXC3CvXpfbi37tGSU5HpdnvJwL4zjgnDUW'));
    should.exist(a);
    should.exist(a.bn);
  });
  ...
  describe('instantiation', function() {
    ...
    it('should not be able to instantiate private key because of network mismatch', function() {
      expect(function() {
        return new PrivateKey('MbProG36JqHhCberkBtXC3CvXpfbi37tGSU5HpdnvJwL4zjgnDUW', 'testnet');
      }).to.throw('Private key network mismatch');
    });

    it('should not be able to instantiate private key WIF is too long', function() {
      expect(function() {
        var buf = Base58Check.decode('Mcz2kdVVjo9JLL96DMYm63HeVJsKy94hKn5Wr6agsyUBjqe5HvNw');
  ...
  describe('#toString', function() {
    ...
    /*
    // KVA does not use uncompressed key
  ...
  describe('#toAddress', function() {
    it('should output this known livenet address correctly', function() {
      ...
      address.toString().should.equal('K7mFLQyqLmBBtggTekvUvrAV27qkW8gegM');
    });
    ...
    it('should output this known livenet witness address correctly', function() {
      ...
      address.toString().should.equal('kva1qqcf9whuh0edw3u9pll3heymc0ska3f6yr3x0q4');
    });
    ...
    it('should output this known livenet wrapped witness address correctly', function() {
      ...
      address.toString().should.equal('VR4uAUcPNhMcsu6HG2ap1zWxmkYjkNmaVs');
    });
  ...
  describe('#inspect', function() {
    it('should output known livenet address for console', function() {
      var privkey = PrivateKey.fromWIF('MbProG36JqHhCberkBtXC3CvXpfbi37tGSU5HpdnvJwL4zjgnDUW');
      privkey.inspect().should.equal(
        '<PrivateKey: 359c60e038eb32cb0d90c71378eae01429f607c2d0b9f84028a4c5d6eadbaf41, network: livenet>'
      );
    });
    ...
    /*
    // KVA does not support uncompressed key
  ...
  describe('#getValidationError', function(){
    ...
    it('should validate as true', function() {
      var a = PrivateKey.isValid('MbkMC1yW1N2EAuNt7WEALsXggQY4JtbD4ft7VEqaEWZfkCHt3TGF');
      a.should.equal(true);
    });
  ...
  describe('#toPublicKey', function() {
    ...
    it('should convert this known PrivateKey to known PublicKey and preserve compressed=true', function() {
      var privwif = 'MhtUzPbzFNLFgApotQthP3TL73wv6WtftQCbEJ6rG11M5uTgU6u1';
  ...
  it('creates an address as expected from WIF, livenet', function() {
    var privkey = new PrivateKey('MbkMC1yW1N2EAuNt7WEALsXggQY4JtbD4ft7VEqaEWZfkCHt3TGF');
    privkey.publicKey.toAddress().toString().should.equal('KQC22AzJXDwPPeWtEt1SfGDyXyBkdN452Q');
  });
